...
| MCP: Native RouteMap protocol + tool routing for LLM clients                           |                                                                  |                                                               |
...
- Production demo deployment runs entirely in GitHub Actions: IaC is built and deployed first, then the app and API are
  built and deployed after the CloudFormation update is stable. The demo stack does not provision CodeBuild or
  CodePipeline deployment resources.
